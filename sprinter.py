...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget.setGeometry(QtCore.QRect(11, 11, 651, 541))
        ...
        self.minutes_per_session_label = QtWidgets.QLabel(self.widget)
        self.minutes_per_session_label.setWordWrap(True)
        self.minutes_per_session_label.setObjectName("minutes_per_session_label")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.minutes_per_session_label)
        self.minutes_per_session_spinbox = QtWidgets.QSpinBox(self.widget)
        self.minutes_per_session_spinbox.setObjectName("minutes_per_session_spinbox")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.minutes_per_session_spinbox)
        self.target_wordcount_label = QtWidgets.QLabel(self.widget)
        ...
        self.target_wordcount_spinbox = QtWidgets.QSpinBox(self.widget)
        ...
        self.severity_label = QtWidgets.QLabel(self.widget)
        ...
        self.severity_slider = QtWidgets.QSlider(self.widget)
        ...
        self.wordcount_progressBar = QtWidgets.QProgressBar(self.widget)
        self.wordcount_progressBar.setProperty("value", 24)
        ...
        self.time_remaining_progressBar = QtWidgets.QProgressBar(self.widget)
        self.time_remaining_progressBar.setProperty("value", 24)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.minutes_per_session_label.setText(_translate("MainWindow", "Minutes per session"))
